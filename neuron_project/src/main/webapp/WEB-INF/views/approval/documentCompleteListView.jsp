			...
			<div class="main-panel">
				<div class="content-wrapper" id="contents">
					...
					<div class="col-lg-6 grid-margin stretch-card"
						...
						<div class="card">
							<div class="card-body">
								<h4 class="card-title" style="float:left">결재완료 문서 조회 </h4>
								...
								<div class="table-responsive">
									<table class="table table-hover">
										...
										<tr align="center" height="20">
									         <td colspan="6">
									         <c:url var="before" value="/approval/documentCompleteListView.do">
									            <c:param name="page" value="${pi.currentPage - 1 }"></c:param>
									         </c:url>
									         <c:url var="after" value="/approval/documentCompleteListView.do">
									            <c:param name="page" value="${pi.currentPage + 1 }"></c:param>         
									         </c:url>
									         <c:url var="pagination" value="/approval/documentCompleteListView.do">
