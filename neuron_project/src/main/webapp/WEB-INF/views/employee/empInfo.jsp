									...
									<div class="row">
										  <div class="col-md-6">
											<div class="form-group row">
												<div class="col-sm-9">
													<img src="../resources/euploadFiles/${loginEmployee.empFileReName}"
										...
										<div class="col-md-6">
											...
											<div class="form-group row">
											  ...
											  <div class="form-group row">
												...
												<div class="col-sm-9" readonly>
													<input type="text" name="empPwd" class="form-control"
														value="${loginEmployee.empPwd}" />
												</div>
											</div>
										</div>
									</div>
											...
											<div class="form-group row">
												...
												<div class="col-sm-9">
													<input type="text" name="empBirth" class="form-control"
														value="${loginEmployee.empBirth}" readonly/>
												</div>
											</div>
										</div>
										<div class="col-md-6">
