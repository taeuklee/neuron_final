...
public class PageInfo {
	...
	public PageInfo(int currentPage, int empLimit, int naviLimit, int startNavi, int endNavi, int titalCount,
			int maxPage) {
		super();
	...
	public String toString() {
		return "PageInfo [currentPage=" + currentPage + ", empLimit=" + empLimit + ", naviLimit=" + naviLimit
